...
/*******************************************************************************
 * A formula - root - having IFF as operator.
 * 
 * @author bianculli
 * 
 */
public class IffRootFormula extends TrioFormula {
	/***************************************************************************
	 ...
	 *            right child negated
	 */
	public IffRootFormula(TrioFormula tf1, TrioFormula tf2,
			TrioFormula tf1_neg, TrioFormula tf2_neg) {
		super(tf1, tf2);
	 ...
	 *            a child negated
	 */
	public IffRootFormula(TrioFormula tf1, TrioFormula tf2, TrioFormula tf_neg) {
