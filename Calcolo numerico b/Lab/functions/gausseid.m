function [xv,iter]=gausseid(A,b,x0,nmax,toll)
%   GAUSSEID Calcola la soluzione del sistema lineare Ax=b utilizzando il metodo iterativo di
%   Gauss-Seidel.
%   [xv,iter]=gausseid(A,b,x0,nmax,toll) calcola la soluzione del sistema lineare Ax=b con tolleranza
...
%         [xv,iter]=gausseid(A,b,zeros(8,1),30,1e-12)
...
%  
%   Vedere anche 
%       funzioni per risolvere sistemi lineari:  JACOB, RICHPRE
